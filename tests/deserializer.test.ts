...
describe('Deserializer', () => {
	...
	test('Deserialize Forged Buffer (Invalid Type)', () => {
		expect.assertions(2);
		try {
	...
	test('Deserialize Forged Buffer (Invalid Number)', () => {
		expect.assertions(2);
		try {
	...
	test('Deserialize Forged Buffer (Invalid BigInt | Missing ByteLength)', () => {
		expect.assertions(2);
		try {
			const uint8Array = new Uint8Array(1);
	...
	test('Deserialize Forged Buffer (Invalid BigInt | Missing Value)', () => {
		expect.assertions(2);
		try {
	...
	test('Deserialize Forged Buffer (Invalid TypedArray | Missing ByteLength)', () => {
		expect.assertions(2);
		try {
			const uint8Array = new Uint8Array(1);
	...
	test('Deserialize Forged Buffer (Invalid TypedArray | Missing Value)', () => {
		expect.assertions(2);
		try {
			const uint8Array = new Uint8Array(5);
			uint8Array[0] = BinaryTokens.Uint8Array;
	...
	test('Deserialize Forged Buffer (String Invalid Null Pointer)', () => {
		expect.assertions(2);
		try {
			const uint8Array = new Uint8Array(2);
	...
	test('Deserialize Forged Buffer (Array Invalid Null Pointer)', () => {
		expect.assertions(2);
		try {
			const uint8Array = new Uint8Array(2);
